...
namespace RawMat.ViewsMaterial.AppearCheck
{
    public partial class userControlSelectAppearPending : UserControl
    {
        ...
        private void dtg_appearPending_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            // 1 แถว = 1 Report — ไม่ผูกกับ APPEARANCE_ID ใด ๆ
            // ปล่อยว่างเพื่อให้หน้า Pending ดึง NG ทุกรายการของ Report มารวมกัน
            propQA.APPEARANCE_ID = "";
            propQA.Lot_No = GetCellValue(e.RowIndex, "Lot No.");
        ...
        private void ApplyReportGridColumnLayout()
        {
            ...
            SetColumnLayout("Receive Date", 90, 85, DataGridViewContentAlignment.MiddleCenter);
            SetColumnLayout("Report No.", 105, 95, DataGridViewContentAlignment.MiddleCenter);
            SetColumnLayout("Lot No.", 95, 85, DataGridViewContentAlignment.MiddleCenter);
            SetColumnLayout("Pending Qty", 80, 75, DataGridViewContentAlignment.MiddleRight);
            SetColumnLayout("Pending Items", 80, 75, DataGridViewContentAlignment.MiddleCenter);
            SetColumnLayout("M-CODE", 95, 85, DataGridViewContentAlignment.MiddleCenter);
            SetColumnLayout("Invoice No.", 105, 95, DataGridViewContentAlignment.MiddleCenter);
            SetColumnLayout("Lot Size", 75, 70, DataGridViewContentAlignment.MiddleRight);
            SetColumnLayout("Inspection Qty", 90, 85, DataGridViewContentAlignment.MiddleRight);
            SetColumnLayout("Vendor", 125, 115, DataGridViewContentAlignment.MiddleLeft);
            SetColumnLayout("Material Name", 185, 170, DataGridViewContentAlignment.MiddleLeft);
            SetColumnLayout("Status", 80, 75, DataGridViewContentAlignment.MiddleCenter);
        }
