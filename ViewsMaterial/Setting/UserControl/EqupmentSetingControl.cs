...
namespace RawMat.ViewsMaterial.Setting
{
    public partial class EqupmentSetingControl : System.Windows.Forms.UserControl
    {
        ...
        private void ApplyColumnFormat()
        {
            ...
            // ตารางนี้ใช้ Fill สองช่องหารกัน ขยายชื่อเครื่องมือ 55 -> 74 (+35%)
            // สัดส่วนจึงเปลี่ยนจาก 55:45 เป็น 74:45 คือชื่อกินพื้นที่ 62% ของตาราง
            SetColumnFill(ColEquipmentName, 74);
