                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                // All = วัดทุกชิ้นใน Lot จำนวนมาจาก Lot Size ตรงๆ ไม่ต้องเปิดตาราง AQL เหมือน Sampling Table
                                propQA.Cavity_Name_List = cavityNames;
                                ...
                                if (!int.TryParse(propQA.Qty, out int lotSize) || lotSize <= 0)
                                {
                                    MessageBox.Show("ไม่พบ Lot Size ของ Report No. : " + propQA.Report_No);
                                    return;
                                }
